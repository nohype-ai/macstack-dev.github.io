...
## Why Formalizing a Tech Stack at all?

allgemeine vorteile dieser art der systematisierung
...
- Conssitency: synchronisation mehrerer maschinen, gewohnter stack überall sofort vorhanden und gleich
...
* Keep Everything up to date and in sync
...
* MacStack brings together existing configuration systems (Brewfile, settings files etc.) rather than inventing a new declarative format. You do not need learn anything new really.
* JSON comments preserved
